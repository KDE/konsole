...
void EditProfileDialog::setupTabsPage(const Profile::Ptr &profile)
{
    ...
    auto formatString = ki18ncp("@item number of seconds", "%v second", "%v seconds");
    KLocalization::setupSpinBoxFormatString(_tabsUi->silenceSecondsSpinner, formatString);
    int silenceCheckBoxWidth = maxSpinBoxWidth(_generalUi->terminalColumnsEntry, formatString);
